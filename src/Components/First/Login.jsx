        ...
        >
          <div className="mainworking flex flex-col  gap-[12px] ">
            <div className="mail">
              ...
              <input
                type="text"
                className="B5 font-Manrope w-[90%] sm:w-full sm:max-w-[350px]    px-[16px] py-[12px] outline-none rounded-[8px]"
            ...
            <div className="password">
              ...
              />
              <FaRegEyeSlash className="w-[20px] h-[18px]" onClick={()=> togglePassword()}/>
              </label>
            ...
            <div className="btn mt-[12px] ">
              <button className="B4 font-Manrope fonr-medium w-[80%] sm:w-full sm:max-w-[350px]  h-[48px] bg-[#FCC378] rounded-[8px] cursor-pointer" onClick={() => navigate("/dashboard")}>
                {" "}
                Sign in{" "}
              </button>
            </div>
